        ...
        <div className="flex flex-col">
          <div className="flex w-full items-center justify-between">
            <div className="flex items-center gap-4">
              <Text className="text-primary-900 text-body font-medium">{title}</Text>
            </div>
...
const MorphingTrigger = () => {
  return (
    <div className="text-gray-600 hover:bg-gray-100 active:bg-gray-100 active:text-accent-400 focus:border-accent-400 disabled:text-gray-400 bg-transparent disabled:bg-transparent rounded-md group relative p-[6px] transition-colors duration-200">
